...
Item {
    ...
    ParallelAnimation {
        ...
        SequentialAnimation {
            ...
            NumberAnimation { target: staggerChild2; property: "opacity"; to: 1; duration: 600; easing.type: Easing.OutCubic }
        }
        SequentialAnimation {
            PauseAnimation { duration: 640 }
            NumberAnimation { target: staggerChild3; property: "opacity"; to: 1; duration: 600; easing.type: Easing.OutCubic }
        }
        SequentialAnimation {
            PauseAnimation { duration: 820 }
            NumberAnimation { target: staggerChild4; property: "opacity"; to: 1; duration: 600; easing.type: Easing.OutCubic }
        }
    }
