...
T.ComboBox {
    ...
    readonly property var __config: (control.editable && control.down && control.popup.visible 
    ...
    popup: T.Popup {
        ...
        background: ItemGroup {
            Impl.StyleImage {
                visible: !control.__isHighContrast
                imageConfig: control.__config.popup_background.filePath ? control.__config.popup_background : Config.controls.popup["normal"].background 
            }
            Rectangle {
                visible: control.__isHighContrast
